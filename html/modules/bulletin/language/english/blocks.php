...
define("_MB_NEWS_DISP_TOPICID","Display category (0=show all)");
define("_MB_NEWS_DISP_HOMETEXT","Number of news showing hometext");
define("_MB_NEWS_DIPS_ICON","Show category icon");

define("_MB_READMORE","Read more...");
define("_MB_COMMENTS","0 comments");
define("_MB_ONECOMMENT","1 comment");
define("_MB_BYTESMORE","%s bytes to go");
define("_MB_NUMCOMMENTS","%s comments");
