...
define("_MI_BULLETIN_BNAME1","ニューストピック");
define("_MI_BULLETIN_BDESC1","ニューストピックブロック");
...
define("_MI_BULLETIN_ADMENU2","トピック管理");
define("_MI_BULLETIN_ADMENU2_D","トピックの管理を行います。");
...
define("_MI_BULLETIN_ADMENU7_D","news1.1から記事・トピックの情報を取り込みます。");
...
define("_MI_BULLETIN_CONFIG7","トピック画像があるディレクトリのパス");
...
define("_MI_BULLETIN_GLOBAL_NEWCATEGORY_NOTIFY", "新規トピック");
define("_MI_BULLETIN_GLOBAL_NEWCATEGORY_NOTIFYCAP", "新規トピックが作成された場合に通知する");
define("_MI_BULLETIN_GLOBAL_NEWCATEGORY_NOTIFYDSC", "新規トピックが作成された場合に通知する");
define("_MI_BULLETIN_GLOBAL_NEWCATEGORY_NOTIFYSBJ", "[{X_SITENAME}] {X_MODULE}: 新規トピックが作成されました");
